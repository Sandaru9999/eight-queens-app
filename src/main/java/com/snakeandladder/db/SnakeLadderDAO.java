...
public class SnakeLadderDAO {
    ...
    public void saveSolution(SnakeLadderSolution solution) throws SQLException {
        String sql = "INSERT INTO solutions (player_name, board_size, correct_throws, player_answer, bfs_time_nanos, dp_time_nanos) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    // Get all solutions from the database, limited by 'limit'
